...
// Web API Tweeting (Direct Twitter API)
+ (BOOL)webAPITweetEnabled {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"webapi_tweet_enabled"];
}

+ (NSString *)webAPIConsumerKey {
    return [[NSUserDefaults standardUserDefaults] stringForKey:@"webapi_consumer_key"] ?: @"";
}

+ (NSString *)webAPIConsumerSecret {
    return [[NSUserDefaults standardUserDefaults] stringForKey:@"webapi_consumer_secret"] ?: @"";
}

+ (NSString *)webAPIAccessToken {
    return [[NSUserDefaults standardUserDefaults] stringForKey:@"webapi_access_token"] ?: @"";
}

+ (NSString *)webAPIAccessSecret {
    return [[NSUserDefaults standardUserDefaults] stringForKey:@"webapi_access_secret"] ?: @"";
}
